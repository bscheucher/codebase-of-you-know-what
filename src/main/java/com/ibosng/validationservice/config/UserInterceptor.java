...
public class UserInterceptor implements HandlerInterceptor {
    ...
    private final ThreadLocal<ValidationUserHolder> userHolderThreadLocal;
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        ...
        if (benutzer != null) {
            ValidationUserHolder validationUserHolder = userHolderThreadLocal.get();
            validationUserHolder.setUsername(benutzer.getEmail());
            validationUserHolder.setUserId(benutzer.getId());
